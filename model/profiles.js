...
module.exports = {
				...
				if (FileValidation(req.file.filename) != 1) {
					...
					if (updatecover(profile_id) == 0) {
						...
						db.query(
                            ...
                            profile_gitlab='${profile_gitlab}',profile_linkedin='${profile_linkedin}',profile_location='${profile_location}',profile_phone_number='${profile_phone_number}',profile_description='${profile_description}',profile_birth_date='${profile_birth_date}'
	...
	GetsingleProfile: (req, res) => {
		return new Promise((resolve, reject) => {
			const { profile_id } = req.query;
			db.query(
				`SELECT  profiles.profile_id, profiles.profile_name , profiles.profile_role , profiles.profile_location , profile_company,profile_sub_company, profiles.profile_job ,profile_linkedin,
